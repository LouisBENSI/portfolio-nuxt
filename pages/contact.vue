      ...
      <div class="grid grid-cols-1 lg:grid-cols-3">
        ...
        <div class="relative overflow-hidden py-4 px-6 bg-secondary xl:p-12">
          ...
          <div class="mt-4 text-sm lg:text-base">
            ...
            <p>Choisissez le sujet qui vous convient et remplissez ce formulaire et je vous répondrais dans les plus
              bref délais !</p>
          </div>
          <div class="hidden lg:block absolute bottom-0 left-0 w-[500px]">
            <img src="~/assets/images/visu-contact.svg" alt="" class="w-full h-full object-contain">
          </div>
        </div>
        ...
        <div class="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
          ...
          <form ref="form" @submit.prevent="validateForm" action="#" method="POST"
            ...
            <div class="sm:col-span-2">
              ...
              <div class="mt-1">
                <select name="subject" v-model="subject" id="subject"
                        class="py-3 px-4 block w-full shadow-sm text-gray-900 focus:ring-secondary focus:border-secondary border-gray-300 rounded-md">
            ...
            <div>
              ...
              <div class="mt-1">
                <input type="text" name="name" id="name" autocomplete="given-name" v-model="nom"
                       class="py-3 px-4 block w-full shadow-sm text-gray-900 focus:ring-secondary focus:border-secondary border-gray-300 rounded-md"/>
              </div>
            </div>
            ...
            <div class="sm:col-span-2">
              ...
              <div class="mt-1">
                ...
                <textarea id="message" name="message" rows="4" v-model="message"
  ...
  <div class="validation min-h-full pt-16 pb-12 flex flex-col hidden">
    <div class="py-16">
      <div class="text-center">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-10 w-8 mx-auto text-secondary" viewBox="0 0 20 20"
             fill="currentColor">
          <path fill-rule="evenodd"
                d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                clip-rule="evenodd"/>
        </svg>
        <h1 class="mt-2 text-2xl font-extrabold text-gray-900 tracking-tight sm:text-4xl">Vos informations ont bien été
          prises en compte !</h1>
        <p class="mt-2 text-base text-gray-500">N'hésitez pas à visiter le reste du site si vous en avez envie ;)</p>
        <div class="mt-6">
          <router-link to="/" class="text-base font-medium text-indigo-600 hover:text-indigo-500">Retourner à la page
            d'accueil<span aria-hidden="true"> &rarr;</span></router-link>
        </div>
      </div>
    </div>
