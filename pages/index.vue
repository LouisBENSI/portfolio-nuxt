...
<template>
  ...
  <section>
    <h2 class="text-2xl font-bold text-primary mb-4">Mes derniers projets</h2>
    <div class="grid gap-6 lg:grid-cols-4">
      <card-projets v-for="p in projets.slice(0, 4)" :name="p.name" :image="p.visuel" :tags="p.tags" :link="'creations/' + p.slug"/>
    </div>
  </section>
</template>